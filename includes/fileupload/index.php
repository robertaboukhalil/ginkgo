<?php
@mkdir("../../data/" . $_GET["user_id"]);
@mkdir("../../data/" . $_GET["user_id"] . "/thumbnail");
?>
<!DOCTYPE HTML>
<!--
/*
...
<!--                <button type="reset" class="btn btn-warning cancel btn-mini">
                    <i class="icon-ban-circle icon-white"></i>
                    <span>Cancel upload</span>
                </button>
-->
<!--                <button type="button" class="btn btn-danger delete btn-mini">
